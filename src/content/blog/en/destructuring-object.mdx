...
summary: 'A guide to object destructuring in JavaScript — extracting properties into variables with renaming, default values, nested objects, and function parameter patterns.'
featured: false
topics: ['javascript']
type: 'tutorial' 
lang: 'en'
