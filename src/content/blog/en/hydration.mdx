...
summary: "Hydration makes a server-rendered page clickable — it walks the painted HTML, matches it to what the framework would render, and wires up interactivity."
image: 'https://images.unsplash.com/photo-1606214554814-e8a9f97bdbb0?w=1200&q=80'
featured: true
