...
summary: 'N+1 query problem terjadi saat list view memicu satu query per baris, bukan satu query total — cara mengenali dan memperbaikinya dengan eager loading.'
image: 'https://images.unsplash.com/photo-1744868562210-fffb7fa882d9?w=1200&q=80'
featured: false
