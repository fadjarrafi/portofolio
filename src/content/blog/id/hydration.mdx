...
summary: 'Hydration yang bikin halaman hasil server-side rendering bisa diklik — menelusuri HTML yang sudah tergambar, mencocokkan ke hasil render framework.'
