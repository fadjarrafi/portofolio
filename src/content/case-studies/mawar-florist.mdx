...
summary: 'A full-stack e-commerce platform for a Yogyakarta florist — storefront, admin dashboard, and an automated payment-to-invoice pipeline on Laravel, Vue, Inertia.'
